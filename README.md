# Blood On The Clocktoken

这是一个本地单局《血染钟楼：暗流涌动》（Blood On The Clocktower: Trouble Brewing）观战器。程序负责规则与说书人裁量，五名 AI 玩家自主推理、交流、私聊、提名、投票并完成游戏；人类只在一个对话式窗口中旁观正文、模型原始推理字段、工具过程、规则事件和笔记检查点。
